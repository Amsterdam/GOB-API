...
FROM public.rel_nap_pmk_gbd_bbk_ligt_in_gebieden_bouwblok"""
        ...
        connection.__enter__.return_value.execute.assert_has_calls([
            ...
            call(f"CREATE OR REPLACE VIEW legacy.rel_mbn_mtg_mbn_rpt_refereert_aan_referentiepunten AS SELECT\n  _id\nFROM public.rel_mbn_mtg_mbn_rpt__rft_n__meetbouten_referentiepunten"),
            ...
            call("CREATE OR REPLACE VIEW legacy.mv_mbn_mtg_mbn_rpt_refereert_aan_referentiepunten AS SELECT * FROM public.mv_mbn_mtg_mbn_rpt__rft_n__meetbouten_referentiepunten"),
        ])
